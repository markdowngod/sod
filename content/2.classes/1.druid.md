...
::code-group
  ::code-block{label="Night Elf"}
   Night Elves have a variety of options obtaining the Lacerate Rune:
    ...
    Darkshore
    - Acquire Crab Treats
      - Slay Blackwood Furbogs
      - Fishing in Darkshore
    - Feed Crab Treats to Young Reef Crawler(36,53) or (39,32)
      - Young Reef Crawler will go friendly and give you Rune of Lacerate
    ***

    Westfall
    - Slay Defias Brotherhood mobs
      - Loot them for Magic Pumpkin Seeds
    - Slay Sea Crawler crabs in the northern coast of Westfall(33,22) 
      - Loot crawlers for Fishy Bonemeal.
    - Slay Kobold Digger in Jangolode Mine northern Westfall
      - Loot kobolds for Fertile Soil Sample
    - Plant Pumpkin Seeds on Westfall farmland
    ***

    Loch Modan
    - Purchase Rainbowfin Albacore Chum from Khara Deepwater located West in Loch Modan near the shore(40,39) for 5 silver.
    - Locate and feed Young Threshadon in the Loch(lake).
    - Loot Rune of Lacerate

  ::
  ::code-block{label="Tauren"}
    Discover in The Barrens(44,22)
    - Interact with an Abandonded Snapjaw Nest and loot it for Abandoned Snapjaw Egg.
    - Bring the egg to Empty Snapjaw Nest (48,40)
    - Placing the egg will give you Rune of Lacerate.
  ::
::
...
::code-group
  ::code-block{label="Night Elf"}
    ...
    ::alert{type="warning"}
      Requires Bear Form to active Idol of Ursine Rage
    ::
    Rageclaw is located underground in the caves West of Dolanaar.
    - Located deep inside the dens he patrols the bottom floor.
    - Slay Rageclaw and loot Idol of Ursine Rage
    ...
    ::alert{type="info"}
      ...
      ::
    - Activate Idol of Ursine Rage on-use effect when you are fully Inspired.
  ::
  ...
  ::code-block{label="Tauren"}
    ...
    ::alert{type="warning"}
      Requires Bear Form to active Idol of Ursine Rage
    ::
    -  Drops off Flatland Prowlwers and Prairie Wolf Alphas across Mulgore
...
::code-group
  ...
  Discover in southern Teldrassil(53,79):
    ...
    Power the three Lunar Stones with Moonfire

    - Two Lunar Stones are near eachother with the third behind the tree
    - Loot the chest surrounded by stones for Rune of the Sun
  ::
  ::code-block{label="Tauren"}
...
::code-group
  ::code-block{label="Night Elf & Tauren"}
    ...
    - Activate the owl statue
      - Protect the wisp from three sets of waves
      - Spawns two level 25 per wave
      - The Symbol of the First Owl object will spawn, dont forget to loot
    ***
    ...
    - Activate the next statue to receive Eyes of the Owl buff
      ...
      - Look for Agon east outside of the Twilight Grove(64,30).

    ::alert{type='warning'}
      Eyes of the Owl are required to see Agon. If you lose the buff, revisit the statue again in the Twilight Grove.
    ::
    - Agon drops Symbol of the Second Owl
    ***
    ...
    - You must reach the other owl statue with the buff to receieve the Symbol of the Third Owl.

    ::alert{type='warning'}
      Aquatic form is needed to reach the second owl within the alloted time.
    ::
    ***

    Return to Moonglade and speak with Loganaar(52,41) 
    - He will give you a quest for the three owls 
    - Complete the quest to receive Rune of Wild Growth.
  ::
::
---
...
::code-group
  ...
  - Interact with Adventurer Remains to start the ritual

  ::alert{type='warning'}
    An additional healing class is required to complete ritual
  ::
    - Priest, Druid, or Paladin may aid in the ritual
    - A ghost spawns and dies becoming lootable for Rune of Life
  ::
  ::code-block{label="Tauren"}
...
::code-group
  ...
  Darkshore(52,38)
  - Slay Den Mother and loot Ferocious Idol
  ***

  Loch Modan
  - North east of Loch Modan Mo'grosh Stronghold
  - Look for tents and a campsite(71,20)
  - Loot the plant object for Ferocious Idol
  ***

  Westfall
  - Slay Gnolls in Westfall
  - Riverpaw Gnolls
    - Various camps on the cliffs of northern Westfall(46,14)
  - Riverpaw Mongrel
    - Various camps west of Westfall(33,48)
  - Loot gnolls for Ferocious Idol

  ::alert{type='warning'}
    Must have lacerate rune or Rip ability(Cat form) to active Ferocious Idol
  ::

  Activation
  - Equip Ferocious Idol
  - Deal 20 applications of Lacerate/Rip to Humanoid mobs
  - Convert Idol on completion to learn Savage Roar.
  ...
  Barrens
  - Slay Kolkar mobs and loot them for Kolkar Booty Key
  - The key opens Kolkar's Booty Chest(44,38) they can also be found at(53,42)
  - Key is relativity a low-drop and the chests do not always contain the Ferocious Idol
  ***

  Silverpine Forest
  - Enter the Deep Elem Mine(56,46)
  - Reach the end and slay Grimson the Pale and loot Ferocious Idol

 ::alert{type='warning'}
    Must have lacerate rune or Rip ability(Cat form) to active Ferocious Idol or
  ::
