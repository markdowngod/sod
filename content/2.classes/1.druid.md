...
::code-group
  ::code-block{label="Night Elf"}
    ...
    ::
      - Once 6 enemies are slain, click on <span style="color:#1EFF0C">Lunar Idol</span> to add <span style="color:#E6CC80">Fury of Stormrage</span> to your rune engraving page.
  ::
...
::code-group
  ...
  ::
  ::code-block{label="Tauren"}
    - Gather 3 Prairie Flower -- they grow throughout Mulgore
    - Combine the flowers into Prairie Crown
    - Awaken Spirit of the Plains named <span style="color:#e4e400">Wooden Effigy</span>(38,49)
    ...
    ::alert{type='warning'}
      Be sure to secure mob tag; it can be stolen, and you would have to craft a new crown.
    ::
