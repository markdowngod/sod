...
::code-group
  ::code-block{label="Night Elf"}
    - Gather 3 **Glade Flowers** -- they grow throughout Teldrassil 
    ::alert{type='info'}
      **Herbalism is not required** to loot these flowers
    ::
    - Combine the flowers into Prairie Crown
    - Awaken Spirit of the Plains named <span style="color:#e4e400">Wooden Effigy</span>(67,57)
    - Placing the Glade Crown on <span style="color:#e4e400">Wooden Effigy</span> summons <span style="color:#e4e400">Unleashed Nature Spirit</span>
    - Loot <span style="color:#1EFF0C">Rune of Natural Potential</span>
  ::
  ::code-block{label="Tauren"}
    - Gather 3 Prairie Flowers -- they grow throughout Mulgore
    ::alert{type='info'}
      **Herbalism is not required** to loot these flowers
    ::
    - Combine the flowers into Prairie Crown
    - Awaken Spirit of the Plains named <span style="color:#e4e400">Wooden Effigy</span>(67,58)
    - Placing the Prairie Crown on <span style="color:#e4e400">Wooden Effigy</span> summons <span style="color:#e4e400">Unleashed Nature Spirit</span>
    - Loot <span style="color:#1EFF0C">Rune of Natural Potential</span>
  ::
::
...
::code-group
  ...
  ::
  ::alert{type="info"}
    Grizzby is located inside the Ratchet Inn.
  ::
  After the gossip dialogue Grizzby will ask you to complete 3 quests.
  ><span style="color:#FFFC01"> **! Fish Oil**
    - Collect 24 Fish Oils 
    - Drop from Murlocs/Nagas from Black Fathom Deeps, Hillsbrad Foothills, or can be purchased off the Auction House.
    ***
  ><span style="color:#FFFC01"> **! Dark Iron Ordinance**
    - Collect 20 Dark Iron Ordinances
    - Drop from Dark Iron elites in Northern Wetlands: Dun Modr
    ***
  ><span style="color:#FFFC01"> **! Shredder Turbochargers**
    - Collect 16 <span style="color:#E2DFD2">**Shredder Turbo Chargers**</span>
      - <span style="color:#999999">**Shredder Turbo Charger**</span> are salvaged from the <span style="color:#E4E400">**Venture Co. Light Shreadder**</span> using Shredder Autosalvage Unit
  ::
::
