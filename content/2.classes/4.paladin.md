...
::code-group
  ...
  Slay Undying Laborer for Libram of Blessings
  ::alert{type="warning"}
    Undying Laborer will go immune at 0 HP. It must be killed with a holy damaging spell(Exorcism, Righteousness Judgement, ect).
  ::
  Libram of Blessings
...
::code-group
  ::code-block{label="Human & Dwarf"}
    ...
    Speak with Brother Romulus

    - He will have a gossip option regarding Ada Gelhardt
    ...
    Locating Ada Gelhardt
    - Fly to Westfall
    - Ada is located on the Hushed Bank northeast of Westfall(65,35)
    - On the map for Duskwood, the island is located(4,28)

    Fight Ada
    - Speak with Ada and go through her dialogue she will then be aggressive.
    - Ada will concede from nearly dying and become friendly
...
::code-group
  ::code-block{label="Human & Dwarf"}
    Purchasable from the Azeroth Commerce Authority
...
::code-group
  ::code-block{label="Human"}
  Discover at Northshire Abbey: Brother Sammuel(50,42):
    Brother Sammuel will give you a quest
    > ! Relics of the Light
